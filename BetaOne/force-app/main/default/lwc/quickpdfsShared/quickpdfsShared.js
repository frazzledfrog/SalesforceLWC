...
export default class QuickpdfsShared extends LightningElement {
    pdfFiles = [
        { id: 'vin_amendment', name: 'VIN Amendment', resourceUrl: VIN_Amendment },
        { id: 'trustee_form', name: 'Trustee Form', resourceUrl: Trustee_Form },
        { id: 'rec_sheet_pdf', name: 'Recreational Vehicle Finance Sheet', resourceUrl: RecSheetPDF },
        { id: 'dealer_signup_eng', name: 'Dealer Sign Up Package (English)', resourceUrl: Dealer_Sign_Up_Package_ENG },
        { id: 'dealer_signup_fr', name: 'Dealer Sign Up Package (French)', resourceUrl: Dealer_Sign_Up_Package_FR },
        { id: 'proof_of_insurance', name: 'Proof of Insurance Form', resourceUrl: Proof_of_Insurance_Form }
    ];
